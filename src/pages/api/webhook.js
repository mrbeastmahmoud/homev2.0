...
//listener for the emulator

const endpointSecurit = process.env.STRIPE_SIGNING_SECRET;
//function async to fill order to firebase
...
export default async (req, res) => {
  if (req.method === "POST") {
    ...
    //handle the checkout session page
...
export const config = {
  api: {
    //handle a webhook have the entile the entire  req az a stream then an phrase object
    bodyParser: false,
    //when we get even stripe will handle it
