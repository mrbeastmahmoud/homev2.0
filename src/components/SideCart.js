              ...
              >
                <div className="flex-grow">
                  <div className="flex">
                    ...
                    <span className="text-gray-900 ml-2 line-clamp-1 cursor-pointer">
                      {item.title}
                    </span>
                  </div>
                ...
                <XIcon
                  ...
                  className="h-5 ml-2 cursor-pointer text-black"
                />
              </div>
            ))
          ) : (
